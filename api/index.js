/*
serverless-ready index.js for Vercel
Paste this as your index.js, then set MONGODB_URI in Vercel Environment Variables.
*/
...
if (!MONGODB_URI) {
  console.error("Missing MONGODB_URI environment variable. Set it in Vercel or .env");
  // Do not throw here because Vercel may still import the file; but log loudly.
}
...
/* Routes (same as your original, unchanged behavior) */
...
/* Ensure DB connects once before handler exported for serverless */
...
const wrapped = serverless(app, { request: true });
